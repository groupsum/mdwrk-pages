...
<p align="center">
  <a href="https://github.com/groupsum/mdwrk-pages/blob/master/packages/40-react-renderers/lander-react/README.md"><img alt="Hits" src="https://visitor-badge.laobi.icu/badge?page_id=groupsum.mdwrk_pages.packages_ui_lander_react_README&amp;left_text=hits" /></a>
...
## Structured Data
Use [@mdwrk/lander-react-structured-data](../../50-machine-output/lander-react-structured-data/README.md) for type-specific JSON-LD React wrappers and schema-intent rendering.
