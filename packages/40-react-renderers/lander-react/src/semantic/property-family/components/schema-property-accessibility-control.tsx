...
(SchemaPropertyAccessibilityControl as typeof SchemaPropertyAccessibilityControl & { toStructuredData: (props: SchemaPropertyAccessibilityControlProps) => unknown }).toStructuredData = (props) =>
