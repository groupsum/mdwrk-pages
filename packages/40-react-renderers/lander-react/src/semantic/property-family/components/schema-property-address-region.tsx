...
(SchemaPropertyAddressRegion as typeof SchemaPropertyAddressRegion & { toStructuredData: (props: SchemaPropertyAddressRegionProps) => unknown }).toStructuredData = (props) =>
