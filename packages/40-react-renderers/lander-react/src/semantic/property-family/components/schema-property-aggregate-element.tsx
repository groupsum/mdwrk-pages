...
(SchemaPropertyAggregateElement as typeof SchemaPropertyAggregateElement & { toStructuredData: (props: SchemaPropertyAggregateElementProps) => unknown }).toStructuredData = (props) =>
