...
(SchemaPropertyAlbumReleaseType as typeof SchemaPropertyAlbumReleaseType & { toStructuredData: (props: SchemaPropertyAlbumReleaseTypeProps) => unknown }).toStructuredData = (props) =>
