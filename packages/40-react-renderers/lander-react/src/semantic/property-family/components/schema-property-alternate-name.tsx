...
(SchemaPropertyAlternateName as typeof SchemaPropertyAlternateName & { toStructuredData: (props: SchemaPropertyAlternateNameProps) => unknown }).toStructuredData = (props) =>
