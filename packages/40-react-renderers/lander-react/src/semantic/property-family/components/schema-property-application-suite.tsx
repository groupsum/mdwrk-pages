...
(SchemaPropertyApplicationSuite as typeof SchemaPropertyApplicationSuite & { toStructuredData: (props: SchemaPropertyApplicationSuiteProps) => unknown }).toStructuredData = (props) =>
