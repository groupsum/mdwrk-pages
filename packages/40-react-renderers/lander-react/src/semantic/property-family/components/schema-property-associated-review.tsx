...
(SchemaPropertyAssociatedReview as typeof SchemaPropertyAssociatedReview & { toStructuredData: (props: SchemaPropertyAssociatedReviewProps) => unknown }).toStructuredData = (props) =>
