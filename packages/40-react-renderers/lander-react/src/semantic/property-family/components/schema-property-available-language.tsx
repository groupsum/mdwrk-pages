...
(SchemaPropertyAvailableLanguage as typeof SchemaPropertyAvailableLanguage & { toStructuredData: (props: SchemaPropertyAvailableLanguageProps) => unknown }).toStructuredData = (props) =>
