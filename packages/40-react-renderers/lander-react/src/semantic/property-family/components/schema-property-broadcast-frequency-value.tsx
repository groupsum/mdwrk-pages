...
(SchemaPropertyBroadcastFrequencyValue as typeof SchemaPropertyBroadcastFrequencyValue & { toStructuredData: (props: SchemaPropertyBroadcastFrequencyValueProps) => unknown }).toStructuredData = (props) =>
