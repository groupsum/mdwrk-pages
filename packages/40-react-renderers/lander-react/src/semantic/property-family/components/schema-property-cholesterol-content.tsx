...
(SchemaPropertyCholesterolContent as typeof SchemaPropertyCholesterolContent & { toStructuredData: (props: SchemaPropertyCholesterolContentProps) => unknown }).toStructuredData = (props) =>
