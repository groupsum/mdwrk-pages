...
(SchemaPropertyDeliveryLeadTime as typeof SchemaPropertyDeliveryLeadTime & { toStructuredData: (props: SchemaPropertyDeliveryLeadTimeProps) => unknown }).toStructuredData = (props) =>
