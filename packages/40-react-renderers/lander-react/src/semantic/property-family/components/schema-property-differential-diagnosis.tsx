...
(SchemaPropertyDifferentialDiagnosis as typeof SchemaPropertyDifferentialDiagnosis & { toStructuredData: (props: SchemaPropertyDifferentialDiagnosisProps) => unknown }).toStructuredData = (props) =>
