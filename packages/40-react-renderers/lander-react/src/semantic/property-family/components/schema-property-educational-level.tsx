...
(SchemaPropertyEducationalLevel as typeof SchemaPropertyEducationalLevel & { toStructuredData: (props: SchemaPropertyEducationalLevelProps) => unknown }).toStructuredData = (props) =>
