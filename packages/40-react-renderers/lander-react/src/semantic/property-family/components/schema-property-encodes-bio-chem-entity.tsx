...
(SchemaPropertyEncodesBioChemEntity as typeof SchemaPropertyEncodesBioChemEntity & { toStructuredData: (props: SchemaPropertyEncodesBioChemEntityProps) => unknown }).toStructuredData = (props) =>
