...
(SchemaPropertyEncodesCreativeWork as typeof SchemaPropertyEncodesCreativeWork & { toStructuredData: (props: SchemaPropertyEncodesCreativeWorkProps) => unknown }).toStructuredData = (props) =>
