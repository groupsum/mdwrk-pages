...
(SchemaPropertyEnergyEfficiencyScaleMin as typeof SchemaPropertyEnergyEfficiencyScaleMin & { toStructuredData: (props: SchemaPropertyEnergyEfficiencyScaleMinProps) => unknown }).toStructuredData = (props) =>
