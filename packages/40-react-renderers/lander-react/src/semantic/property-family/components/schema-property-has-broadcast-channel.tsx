...
(SchemaPropertyHasBroadcastChannel as typeof SchemaPropertyHasBroadcastChannel & { toStructuredData: (props: SchemaPropertyHasBroadcastChannelProps) => unknown }).toStructuredData = (props) =>
