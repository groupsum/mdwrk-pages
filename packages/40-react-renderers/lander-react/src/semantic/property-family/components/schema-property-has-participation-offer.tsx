...
(SchemaPropertyHasParticipationOffer as typeof SchemaPropertyHasParticipationOffer & { toStructuredData: (props: SchemaPropertyHasParticipationOfferProps) => unknown }).toStructuredData = (props) =>
