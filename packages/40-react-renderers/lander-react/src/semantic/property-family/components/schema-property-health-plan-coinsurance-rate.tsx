...
(SchemaPropertyHealthPlanCoinsuranceRate as typeof SchemaPropertyHealthPlanCoinsuranceRate & { toStructuredData: (props: SchemaPropertyHealthPlanCoinsuranceRateProps) => unknown }).toStructuredData = (props) =>
