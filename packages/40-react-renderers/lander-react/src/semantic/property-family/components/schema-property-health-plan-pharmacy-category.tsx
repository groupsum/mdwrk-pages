...
(SchemaPropertyHealthPlanPharmacyCategory as typeof SchemaPropertyHealthPlanPharmacyCategory & { toStructuredData: (props: SchemaPropertyHealthPlanPharmacyCategoryProps) => unknown }).toStructuredData = (props) =>
