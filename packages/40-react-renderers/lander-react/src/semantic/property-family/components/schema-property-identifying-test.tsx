...
(SchemaPropertyIdentifyingTest as typeof SchemaPropertyIdentifyingTest & { toStructuredData: (props: SchemaPropertyIdentifyingTestProps) => unknown }).toStructuredData = (props) =>
