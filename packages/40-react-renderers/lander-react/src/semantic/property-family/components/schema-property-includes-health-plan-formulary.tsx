...
(SchemaPropertyIncludesHealthPlanFormulary as typeof SchemaPropertyIncludesHealthPlanFormulary & { toStructuredData: (props: SchemaPropertyIncludesHealthPlanFormularyProps) => unknown }).toStructuredData = (props) =>
