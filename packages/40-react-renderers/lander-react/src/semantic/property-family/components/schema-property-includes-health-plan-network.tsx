...
(SchemaPropertyIncludesHealthPlanNetwork as typeof SchemaPropertyIncludesHealthPlanNetwork & { toStructuredData: (props: SchemaPropertyIncludesHealthPlanNetworkProps) => unknown }).toStructuredData = (props) =>
