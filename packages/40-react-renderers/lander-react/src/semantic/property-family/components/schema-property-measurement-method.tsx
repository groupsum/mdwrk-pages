...
(SchemaPropertyMeasurementMethod as typeof SchemaPropertyMeasurementMethod & { toStructuredData: (props: SchemaPropertyMeasurementMethodProps) => unknown }).toStructuredData = (props) =>
