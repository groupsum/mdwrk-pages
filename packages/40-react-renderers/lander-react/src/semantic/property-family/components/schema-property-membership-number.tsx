...
(SchemaPropertyMembershipNumber as typeof SchemaPropertyMembershipNumber & { toStructuredData: (props: SchemaPropertyMembershipNumberProps) => unknown }).toStructuredData = (props) =>
