...
(SchemaPropertyNumberOfEmployees as typeof SchemaPropertyNumberOfEmployees & { toStructuredData: (props: SchemaPropertyNumberOfEmployeesProps) => unknown }).toStructuredData = (props) =>
