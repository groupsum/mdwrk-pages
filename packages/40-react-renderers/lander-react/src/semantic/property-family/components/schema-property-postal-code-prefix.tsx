...
(SchemaPropertyPostalCodePrefix as typeof SchemaPropertyPostalCodePrefix & { toStructuredData: (props: SchemaPropertyPostalCodePrefixProps) => unknown }).toStructuredData = (props) =>
