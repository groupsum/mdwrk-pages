...
(SchemaPropertyPriceComponentType as typeof SchemaPropertyPriceComponentType & { toStructuredData: (props: SchemaPropertyPriceComponentTypeProps) => unknown }).toStructuredData = (props) =>
