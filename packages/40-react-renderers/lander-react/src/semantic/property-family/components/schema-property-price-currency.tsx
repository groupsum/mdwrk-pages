...
(SchemaPropertyPriceCurrency as typeof SchemaPropertyPriceCurrency & { toStructuredData: (props: SchemaPropertyPriceCurrencyProps) => unknown }).toStructuredData = (props) =>
