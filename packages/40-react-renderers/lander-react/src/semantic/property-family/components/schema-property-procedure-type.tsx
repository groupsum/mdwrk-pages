...
(SchemaPropertyProcedureType as typeof SchemaPropertyProcedureType & { toStructuredData: (props: SchemaPropertyProcedureTypeProps) => unknown }).toStructuredData = (props) =>
