...
(SchemaPropertyProprietaryName as typeof SchemaPropertyProprietaryName & { toStructuredData: (props: SchemaPropertyProprietaryNameProps) => unknown }).toStructuredData = (props) =>
