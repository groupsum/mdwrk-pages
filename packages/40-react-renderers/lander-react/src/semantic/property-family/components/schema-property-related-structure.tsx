...
(SchemaPropertyRelatedStructure as typeof SchemaPropertyRelatedStructure & { toStructuredData: (props: SchemaPropertyRelatedStructureProps) => unknown }).toStructuredData = (props) =>
