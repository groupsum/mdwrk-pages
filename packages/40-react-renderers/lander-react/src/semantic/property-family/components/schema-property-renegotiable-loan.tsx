...
(SchemaPropertyRenegotiableLoan as typeof SchemaPropertyRenegotiableLoan & { toStructuredData: (props: SchemaPropertyRenegotiableLoanProps) => unknown }).toStructuredData = (props) =>
