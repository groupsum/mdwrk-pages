...
(SchemaPropertySeasonalOverride as typeof SchemaPropertySeasonalOverride & { toStructuredData: (props: SchemaPropertySeasonalOverrideProps) => unknown }).toStructuredData = (props) =>
