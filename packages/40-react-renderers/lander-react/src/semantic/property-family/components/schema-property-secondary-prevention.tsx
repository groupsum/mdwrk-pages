...
(SchemaPropertySecondaryPrevention as typeof SchemaPropertySecondaryPrevention & { toStructuredData: (props: SchemaPropertySecondaryPreventionProps) => unknown }).toStructuredData = (props) =>
