...
(SchemaPropertyShippingOrigin as typeof SchemaPropertyShippingOrigin & { toStructuredData: (props: SchemaPropertyShippingOriginProps) => unknown }).toStructuredData = (props) =>
