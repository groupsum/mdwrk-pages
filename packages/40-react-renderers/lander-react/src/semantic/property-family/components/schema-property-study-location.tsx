...
(SchemaPropertyStudyLocation as typeof SchemaPropertyStudyLocation & { toStructuredData: (props: SchemaPropertyStudyLocationProps) => unknown }).toStructuredData = (props) =>
