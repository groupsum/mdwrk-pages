...
(SchemaPropertySuitableForDiet as typeof SchemaPropertySuitableForDiet & { toStructuredData: (props: SchemaPropertySuitableForDietProps) => unknown }).toStructuredData = (props) =>
