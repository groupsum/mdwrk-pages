...
(SchemaPropertyTaxonomicRange as typeof SchemaPropertyTaxonomicRange & { toStructuredData: (props: SchemaPropertyTaxonomicRangeProps) => unknown }).toStructuredData = (props) =>
