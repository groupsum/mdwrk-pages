...
(SchemaPropertyTransFatContent as typeof SchemaPropertyTransFatContent & { toStructuredData: (props: SchemaPropertyTransFatContentProps) => unknown }).toStructuredData = (props) =>
