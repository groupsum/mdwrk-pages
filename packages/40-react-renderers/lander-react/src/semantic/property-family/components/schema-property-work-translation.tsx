...
(SchemaPropertyWorkTranslation as typeof SchemaPropertyWorkTranslation & { toStructuredData: (props: SchemaPropertyWorkTranslationProps) => unknown }).toStructuredData = (props) =>
