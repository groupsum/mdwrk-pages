...
docker build -f packages/70-demos/page-template-demo/Dockerfile -t mdwrk-page-template-demo .
...
```bash
docker compose -f packages/70-demos/page-template-demo/compose.yaml up --build -d
```
