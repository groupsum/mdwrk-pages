...
```bash
docker compose -f packages/70-demos/semantic-components-demo/compose.yaml up --build -d
docker compose -f packages/70-demos/semantic-components-demo/compose.yaml ps
```
