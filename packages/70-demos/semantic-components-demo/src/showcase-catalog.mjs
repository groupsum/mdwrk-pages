...
function generatedProofPathsForArtifact(artifact) {
  return [
    "packages/40-react-renderers/lander-react/src/semantic/generated-components.tsx",
    "packages/40-react-renderers/lander-react/tests/generated-schemaorg-semantic-t1.test.mjs",
    "packages/40-react-renderers/lander-react-structured-data/tests/generated-schemaorg-wrappers-t1.test.mjs",
...
function generatedTokenFilesForArtifact(artifact) {
  return [
    "packages/30-ui-foundation/pages-ui-tokens/src/styles/generated-semantic-surface.css",
    `packages/30-ui-foundation/pages-ui-tokens/src/styles/semantic-${artifact.slug}.css`,
  ];
}
