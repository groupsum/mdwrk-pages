...
(SchemaPropertyAcceptedPaymentMethod as typeof SchemaPropertyAcceptedPaymentMethod & { toStructuredData: (props: SchemaPropertyAcceptedPaymentMethodProps) => unknown }).toStructuredData = (props) =>
