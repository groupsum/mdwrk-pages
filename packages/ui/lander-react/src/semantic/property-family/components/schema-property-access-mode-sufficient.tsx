...
(SchemaPropertyAccessModeSufficient as typeof SchemaPropertyAccessModeSufficient & { toStructuredData: (props: SchemaPropertyAccessModeSufficientProps) => unknown }).toStructuredData = (props) =>
