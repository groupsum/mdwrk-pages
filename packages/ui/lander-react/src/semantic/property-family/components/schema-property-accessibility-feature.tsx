...
(SchemaPropertyAccessibilityFeature as typeof SchemaPropertyAccessibilityFeature & { toStructuredData: (props: SchemaPropertyAccessibilityFeatureProps) => unknown }).toStructuredData = (props) =>
