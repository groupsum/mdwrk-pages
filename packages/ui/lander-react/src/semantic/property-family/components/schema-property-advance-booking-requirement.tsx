...
(SchemaPropertyAdvanceBookingRequirement as typeof SchemaPropertyAdvanceBookingRequirement & { toStructuredData: (props: SchemaPropertyAdvanceBookingRequirementProps) => unknown }).toStructuredData = (props) =>
