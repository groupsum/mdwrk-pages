...
(SchemaPropertyAlternativeHeadline as typeof SchemaPropertyAlternativeHeadline & { toStructuredData: (props: SchemaPropertyAlternativeHeadlineProps) => unknown }).toStructuredData = (props) =>
