...
(SchemaPropertyApplicableCountry as typeof SchemaPropertyApplicableCountry & { toStructuredData: (props: SchemaPropertyApplicableCountryProps) => unknown }).toStructuredData = (props) =>
