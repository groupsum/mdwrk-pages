...
(SchemaPropertyApplicableLocation as typeof SchemaPropertyApplicableLocation & { toStructuredData: (props: SchemaPropertyApplicableLocationProps) => unknown }).toStructuredData = (props) =>
