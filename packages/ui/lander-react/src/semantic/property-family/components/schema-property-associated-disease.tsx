...
(SchemaPropertyAssociatedDisease as typeof SchemaPropertyAssociatedDisease & { toStructuredData: (props: SchemaPropertyAssociatedDiseaseProps) => unknown }).toStructuredData = (props) =>
