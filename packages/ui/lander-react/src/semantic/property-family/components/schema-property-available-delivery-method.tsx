...
(SchemaPropertyAvailableDeliveryMethod as typeof SchemaPropertyAvailableDeliveryMethod & { toStructuredData: (props: SchemaPropertyAvailableDeliveryMethodProps) => unknown }).toStructuredData = (props) =>
