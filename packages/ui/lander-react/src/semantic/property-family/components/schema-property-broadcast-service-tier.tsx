...
(SchemaPropertyBroadcastServiceTier as typeof SchemaPropertyBroadcastServiceTier & { toStructuredData: (props: SchemaPropertyBroadcastServiceTierProps) => unknown }).toStructuredData = (props) =>
