...
(SchemaPropertyClaimInterpreter as typeof SchemaPropertyClaimInterpreter & { toStructuredData: (props: SchemaPropertyClaimInterpreterProps) => unknown }).toStructuredData = (props) =>
