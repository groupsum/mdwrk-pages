...
(SchemaPropertyContentLocation as typeof SchemaPropertyContentLocation & { toStructuredData: (props: SchemaPropertyContentLocationProps) => unknown }).toStructuredData = (props) =>
