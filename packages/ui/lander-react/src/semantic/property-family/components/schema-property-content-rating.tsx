...
(SchemaPropertyContentRating as typeof SchemaPropertyContentRating & { toStructuredData: (props: SchemaPropertyContentRatingProps) => unknown }).toStructuredData = (props) =>
