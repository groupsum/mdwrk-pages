...
(SchemaPropertyContraindication as typeof SchemaPropertyContraindication & { toStructuredData: (props: SchemaPropertyContraindicationProps) => unknown }).toStructuredData = (props) =>
