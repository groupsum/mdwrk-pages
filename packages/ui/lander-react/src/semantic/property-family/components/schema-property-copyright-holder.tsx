...
(SchemaPropertyCopyrightHolder as typeof SchemaPropertyCopyrightHolder & { toStructuredData: (props: SchemaPropertyCopyrightHolderProps) => unknown }).toStructuredData = (props) =>
