...
(SchemaPropertyCountriesSupported as typeof SchemaPropertyCountriesSupported & { toStructuredData: (props: SchemaPropertyCountriesSupportedProps) => unknown }).toStructuredData = (props) =>
