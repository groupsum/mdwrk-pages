...
(SchemaPropertyCountryOfOrigin as typeof SchemaPropertyCountryOfOrigin & { toStructuredData: (props: SchemaPropertyCountryOfOriginProps) => unknown }).toStructuredData = (props) =>
