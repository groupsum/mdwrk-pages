...
(SchemaPropertyCustomerRemorseReturnFees as typeof SchemaPropertyCustomerRemorseReturnFees & { toStructuredData: (props: SchemaPropertyCustomerRemorseReturnFeesProps) => unknown }).toStructuredData = (props) =>
