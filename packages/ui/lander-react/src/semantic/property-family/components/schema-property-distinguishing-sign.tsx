...
(SchemaPropertyDistinguishingSign as typeof SchemaPropertyDistinguishingSign & { toStructuredData: (props: SchemaPropertyDistinguishingSignProps) => unknown }).toStructuredData = (props) =>
