...
(SchemaPropertyEducationalAlignment as typeof SchemaPropertyEducationalAlignment & { toStructuredData: (props: SchemaPropertyEducationalAlignmentProps) => unknown }).toStructuredData = (props) =>
