...
(SchemaPropertyGlobalLocationNumber as typeof SchemaPropertyGlobalLocationNumber & { toStructuredData: (props: SchemaPropertyGlobalLocationNumberProps) => unknown }).toStructuredData = (props) =>
