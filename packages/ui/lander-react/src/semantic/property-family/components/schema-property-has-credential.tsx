...
(SchemaPropertyHasCredential as typeof SchemaPropertyHasCredential & { toStructuredData: (props: SchemaPropertyHasCredentialProps) => unknown }).toStructuredData = (props) =>
