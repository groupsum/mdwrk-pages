...
(SchemaPropertyHealthPlanCopayOption as typeof SchemaPropertyHealthPlanCopayOption & { toStructuredData: (props: SchemaPropertyHealthPlanCopayOptionProps) => unknown }).toStructuredData = (props) =>
