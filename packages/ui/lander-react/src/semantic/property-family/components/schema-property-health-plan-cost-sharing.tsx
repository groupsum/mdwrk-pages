...
(SchemaPropertyHealthPlanCostSharing as typeof SchemaPropertyHealthPlanCostSharing & { toStructuredData: (props: SchemaPropertyHealthPlanCostSharingProps) => unknown }).toStructuredData = (props) =>
