...
(SchemaPropertyHealthPlanNetworkId as typeof SchemaPropertyHealthPlanNetworkId & { toStructuredData: (props: SchemaPropertyHealthPlanNetworkIdProps) => unknown }).toStructuredData = (props) =>
