...
(SchemaPropertyInDefinedTermSet as typeof SchemaPropertyInDefinedTermSet & { toStructuredData: (props: SchemaPropertyInDefinedTermSetProps) => unknown }).toStructuredData = (props) =>
