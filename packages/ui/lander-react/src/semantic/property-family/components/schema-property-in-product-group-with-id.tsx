...
(SchemaPropertyInProductGroupWithID as typeof SchemaPropertyInProductGroupWithID & { toStructuredData: (props: SchemaPropertyInProductGroupWithIDProps) => unknown }).toStructuredData = (props) =>
