...
(SchemaPropertyIsConsumableFor as typeof SchemaPropertyIsConsumableFor & { toStructuredData: (props: SchemaPropertyIsConsumableForProps) => unknown }).toStructuredData = (props) =>
