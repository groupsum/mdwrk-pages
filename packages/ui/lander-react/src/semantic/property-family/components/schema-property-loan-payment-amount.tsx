...
(SchemaPropertyLoanPaymentAmount as typeof SchemaPropertyLoanPaymentAmount & { toStructuredData: (props: SchemaPropertyLoanPaymentAmountProps) => unknown }).toStructuredData = (props) =>
