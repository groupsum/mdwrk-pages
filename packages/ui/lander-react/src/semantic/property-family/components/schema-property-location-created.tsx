...
(SchemaPropertyLocationCreated as typeof SchemaPropertyLocationCreated & { toStructuredData: (props: SchemaPropertyLocationCreatedProps) => unknown }).toStructuredData = (props) =>
