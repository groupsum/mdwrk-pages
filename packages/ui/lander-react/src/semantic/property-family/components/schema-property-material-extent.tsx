...
(SchemaPropertyMaterialExtent as typeof SchemaPropertyMaterialExtent & { toStructuredData: (props: SchemaPropertyMaterialExtentProps) => unknown }).toStructuredData = (props) =>
