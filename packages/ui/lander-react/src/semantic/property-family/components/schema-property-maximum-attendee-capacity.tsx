...
(SchemaPropertyMaximumAttendeeCapacity as typeof SchemaPropertyMaximumAttendeeCapacity & { toStructuredData: (props: SchemaPropertyMaximumAttendeeCapacityProps) => unknown }).toStructuredData = (props) =>
