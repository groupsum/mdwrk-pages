...
(SchemaPropertyMusicCompositionForm as typeof SchemaPropertyMusicCompositionForm & { toStructuredData: (props: SchemaPropertyMusicCompositionFormProps) => unknown }).toStructuredData = (props) =>
