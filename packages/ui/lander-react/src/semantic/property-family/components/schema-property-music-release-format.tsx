...
(SchemaPropertyMusicReleaseFormat as typeof SchemaPropertyMusicReleaseFormat & { toStructuredData: (props: SchemaPropertyMusicReleaseFormatProps) => unknown }).toStructuredData = (props) =>
