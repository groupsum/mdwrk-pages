...
(SchemaPropertyNumberOfItems as typeof SchemaPropertyNumberOfItems & { toStructuredData: (props: SchemaPropertyNumberOfItemsProps) => unknown }).toStructuredData = (props) =>
