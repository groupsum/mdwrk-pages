...
(SchemaPropertyOperatingSystem as typeof SchemaPropertyOperatingSystem & { toStructuredData: (props: SchemaPropertyOperatingSystemProps) => unknown }).toStructuredData = (props) =>
