...
(SchemaPropertyOwnershipFundingInfo as typeof SchemaPropertyOwnershipFundingInfo & { toStructuredData: (props: SchemaPropertyOwnershipFundingInfoProps) => unknown }).toStructuredData = (props) =>
