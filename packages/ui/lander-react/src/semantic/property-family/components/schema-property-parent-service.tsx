...
(SchemaPropertyParentService as typeof SchemaPropertyParentService & { toStructuredData: (props: SchemaPropertyParentServiceProps) => unknown }).toStructuredData = (props) =>
