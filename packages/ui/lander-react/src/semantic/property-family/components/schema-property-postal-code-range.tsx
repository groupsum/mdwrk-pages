...
(SchemaPropertyPostalCodeRange as typeof SchemaPropertyPostalCodeRange & { toStructuredData: (props: SchemaPropertyPostalCodeRangeProps) => unknown }).toStructuredData = (props) =>
