...
(SchemaPropertyPredecessorOf as typeof SchemaPropertyPredecessorOf & { toStructuredData: (props: SchemaPropertyPredecessorOfProps) => unknown }).toStructuredData = (props) =>
