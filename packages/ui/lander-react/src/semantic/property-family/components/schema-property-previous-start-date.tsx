...
(SchemaPropertyPreviousStartDate as typeof SchemaPropertyPreviousStartDate & { toStructuredData: (props: SchemaPropertyPreviousStartDateProps) => unknown }).toStructuredData = (props) =>
