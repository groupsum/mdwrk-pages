...
(SchemaPropertyPriceSpecification as typeof SchemaPropertyPriceSpecification & { toStructuredData: (props: SchemaPropertyPriceSpecificationProps) => unknown }).toStructuredData = (props) =>
