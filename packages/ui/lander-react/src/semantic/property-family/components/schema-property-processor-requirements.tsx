...
(SchemaPropertyProcessorRequirements as typeof SchemaPropertyProcessorRequirements & { toStructuredData: (props: SchemaPropertyProcessorRequirementsProps) => unknown }).toStructuredData = (props) =>
