...
(SchemaPropertyProductionDate as typeof SchemaPropertyProductionDate & { toStructuredData: (props: SchemaPropertyProductionDateProps) => unknown }).toStructuredData = (props) =>
