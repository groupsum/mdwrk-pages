...
(SchemaPropertyProviderMobility as typeof SchemaPropertyProviderMobility & { toStructuredData: (props: SchemaPropertyProviderMobilityProps) => unknown }).toStructuredData = (props) =>
