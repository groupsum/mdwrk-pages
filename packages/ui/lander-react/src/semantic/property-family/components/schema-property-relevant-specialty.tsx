...
(SchemaPropertyRelevantSpecialty as typeof SchemaPropertyRelevantSpecialty & { toStructuredData: (props: SchemaPropertyRelevantSpecialtyProps) => unknown }).toStructuredData = (props) =>
