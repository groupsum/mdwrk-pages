...
(SchemaPropertyRepeatFrequency as typeof SchemaPropertyRepeatFrequency & { toStructuredData: (props: SchemaPropertyRepeatFrequencyProps) => unknown }).toStructuredData = (props) =>
