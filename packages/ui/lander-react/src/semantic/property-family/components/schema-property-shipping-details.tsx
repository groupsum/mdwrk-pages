...
(SchemaPropertyShippingDetails as typeof SchemaPropertyShippingDetails & { toStructuredData: (props: SchemaPropertyShippingDetailsProps) => unknown }).toStructuredData = (props) =>
