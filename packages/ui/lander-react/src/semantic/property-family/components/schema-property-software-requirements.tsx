...
(SchemaPropertySoftwareRequirements as typeof SchemaPropertySoftwareRequirements & { toStructuredData: (props: SchemaPropertySoftwareRequirementsProps) => unknown }).toStructuredData = (props) =>
