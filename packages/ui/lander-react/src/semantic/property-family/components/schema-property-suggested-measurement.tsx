...
(SchemaPropertySuggestedMeasurement as typeof SchemaPropertySuggestedMeasurement & { toStructuredData: (props: SchemaPropertySuggestedMeasurementProps) => unknown }).toStructuredData = (props) =>
