...
(SchemaPropertySuggestedMinAge as typeof SchemaPropertySuggestedMinAge & { toStructuredData: (props: SchemaPropertySuggestedMinAgeProps) => unknown }).toStructuredData = (props) =>
