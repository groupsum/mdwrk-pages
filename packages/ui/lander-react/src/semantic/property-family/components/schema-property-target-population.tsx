...
(SchemaPropertyTargetPopulation as typeof SchemaPropertyTargetPopulation & { toStructuredData: (props: SchemaPropertyTargetPopulationProps) => unknown }).toStructuredData = (props) =>
