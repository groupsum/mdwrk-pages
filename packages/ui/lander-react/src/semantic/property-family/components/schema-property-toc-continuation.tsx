...
(SchemaPropertyTocContinuation as typeof SchemaPropertyTocContinuation & { toStructuredData: (props: SchemaPropertyTocContinuationProps) => unknown }).toStructuredData = (props) =>
