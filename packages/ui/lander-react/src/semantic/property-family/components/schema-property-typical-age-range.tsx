...
(SchemaPropertyTypicalAgeRange as typeof SchemaPropertyTypicalAgeRange & { toStructuredData: (props: SchemaPropertyTypicalAgeRangeProps) => unknown }).toStructuredData = (props) =>
