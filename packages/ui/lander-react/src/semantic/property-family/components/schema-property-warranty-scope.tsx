...
(SchemaPropertyWarrantyScope as typeof SchemaPropertyWarrantyScope & { toStructuredData: (props: SchemaPropertyWarrantyScopeProps) => unknown }).toStructuredData = (props) =>
