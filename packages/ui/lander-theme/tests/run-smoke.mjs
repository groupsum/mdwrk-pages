...
assert.ok(css.includes('@import url("@mdwrk/pages-ui-tokens/styles/root.css");'));
assert.ok(css.includes('@import url("@mdwrk/pages-ui-tokens/styles/semantic-article.css");'));
assert.ok(css.includes('@import url("@mdwrk/pages-ui-tokens/styles/semantic-product.css");'));
assert.ok(css.includes('@import url("@mdwrk/pages-ui-tokens/styles/semantic-course.css");'));
assert.ok(css.includes('@import url("@mdwrk/pages-ui-tokens/styles/semantic-quiz.css");'));
